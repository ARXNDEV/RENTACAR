                      ...
                      <div className="mx-auto max-w-[320px] px-4 py-2 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
                        ...
                        <div className="my-2 font-mono">
                          ...
                          <div className="flex justify-center items-center gap-x-5  my-3">
                            <button
                              className="bg-green-500 hover:bg-green-600 px-4 py-2 w-[100px] rounded-2xl text-white font-bold transition-all active:scale-95"
                              onClick={() => {
                                if (!cur._id) return toast.error("Variant ID missing");
