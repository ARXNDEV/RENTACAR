    ...
    {activeMenu && (
      <>
        ...
        <div className="mt-6 px-2">
           <Link 
             to="/"
             className="flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-md text-gray-700 bg-slate-50 hover:bg-slate-100 mb-4 border border-slate-100"
           >
             <LuHome className="text-xl" />
             <span className="capitalize font-semibold text-gray-600 tracking-tight">Return to Home</span>
           </Link>
        </div>
